...
class CommentController
{
    ...
    public function showAction(int $commentId, Templating $templating, Router $router): ?string
    {
        ...
        if (! $comment) throw new NotFoundException("Missing comment id: $commentId");
    ...
    public function editAction(int $commentId, ?array $requestComment,
                               Templating $templating, Router $router): ?string
    {
        $comment = Comment::find($commentId);
        if (! $comment) throw new NotFoundException("Missing comment id: $commentId");
